R,(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11)=polynomial_ring(QQ, ["x1","x2","x3","x4","x5","x6","x7","x8","x9","x10","x11"],ordering=:degrevlex)
sys = [x1+2*x2+2*x3+2*x4+2*x5+2*x6+2*x7+2*x8+2*x9+2*x10+2*x11-1,
